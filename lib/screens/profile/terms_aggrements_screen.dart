    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Text(
            'Last updated: (3/20/2021) Please read these Terms and Conditions carefully before using the http://www.SweetHome.com website and the SweetHome mobile application operated by SweetHome. Your access to and use of the Service is conditioned on your acceptance of and compliance with these Terms.\n These Terms apply to all visitors, users and others who access or use the Service.By accessing or using the Service you agree to be bound by these Terms.\n If you disagree with any part of the terms then you may not access the Service.\n'
